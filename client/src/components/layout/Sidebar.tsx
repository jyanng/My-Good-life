...
import { BarChart2, Kanban, FileDown, FileText, TrendingUp, Users } from "lucide-react";
...
export default function Sidebar({ user, mobileMenuOpen, setMobileMenuOpen }: SidebarProps) {
  ...
  const navItems = [
    ...
    { path: "/circle-of-support", label: "Circle of Support", icon: <Users className="w-5 h-5" /> },
