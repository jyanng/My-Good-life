...
export default function MyGoodLifePlan() {
  const { toast } = useToast();
  const [isPlanModalOpen, setIsPlanModalOpen] = useState(false);
  
  const studentId = 1; // Using Wei Jie Tan as the default student
    ...
    return (
      <div className="p-4 md:p-8 pt-16 md:pt-8">
        <div className="bg-white rounded-lg shadow p-8 text-center">
          <h2 className="text-2xl font-bold text-red-500 mb-4">Plan Data Not Found</h2>
          <p className="text-gray-600 mb-6">Unable to retrieve your MyGoodLife Plan data. Please try again later.</p>
          <Link href="/">
  ...
  return (
    <div className="p-4 md:p-8 pt-16 md:pt-8">
        ...
        <div className="md:flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="max-w-xs md:max-w-sm overflow-hidden">
              <h2 className="text-2xl font-bold text-gray-900 break-words">My Good Life Plan</h2>
              <p className="text-gray-600 break-all">{student.name}</p>
            </div>
          </div>
          <div className="flex mt-4 md:mt-0 space-x-2">
            ...
            <Link href={`/plan-builder/${studentId}`}>
              <Button>
      ...
      <Tabs defaultValue="plan" className="bg-white rounded-lg shadow">
          ...
          {isLoadingPlan || isLoadingDomainPlans ? (
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-medium">My Life Domains</h3>
            ...
            <div className="text-center py-12 border border-dashed border-gray-300 rounded-lg">
              <p className="text-gray-500">You haven't created your Good Life Plan yet.</p>
              <Link href={`/plan-builder/${studentId}`}>
                <Button className="mt-4">Create My Good Life Plan</Button>
              </Link>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="progress" className="p-6 focus:outline-none">
          <div className="text-center py-12">
            <h3 className="text-lg font-medium mb-4">My Progress</h3>
            <p className="text-gray-500">Track your progress across all your life domains. This feature will be enhanced in the next update.</p>
          </div>
        </TabsContent>
      </Tabs>
